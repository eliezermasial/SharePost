...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="{{"back_auth/assets/img/favicon.png"}}">
	<link rel="stylesheet" href="{{"back_auth/assets/css/bootstrap.min.css"}}">
	<link rel="stylesheet" href="{{"back_auth/assets/plugins/fontawesome/css/all.min.css"}}">
...
<body>
	...
	<script src="{{"back_auth/assets/js/jquery-3.5.1.min.js"}}"></script>
	<script src="{{"back_auth/assets/js/popper.min.js"}}"></script>
	<script src="{{"back_auth/assets/js/bootstrap.min.js"}}"></script>
